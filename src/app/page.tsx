...
/** 
 * App Router: Server Component page (default).
 * Geen 'use client' hier. Client components worden binnenin gewoon gebruikt.
 */
const EXHIBITIONS = [
  ...
  return (
    <>
      ...
      <VisitorCard aria-labelledby="visitor-info-title">
        ...
        <Value>Daily 9:00–18:00</Value>
        <Label>Location</Label>
        <Value>Amsterdam<br/>Noord-Holland</Value>
        <Label>Image Credit</Label>
        <Credit>
          Van Gogh Museum via{" "}
          <a href="#" target="_blank" rel="noopener">Van Gogh Museum</a>
        </Credit>
      </VisitorCard>
    </>
  );
